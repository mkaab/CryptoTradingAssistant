...
Fix Data (~1-2 days): Use CoinGecko for market cap (circulating supply * price) and 30d OHLC.
Sentiment (~1 day): Add X posts/news (CryptoPanic) for setup context.
Custom Prompt (~1 day): UI inputs for pair (e.g., BNB/USDT), direction (long/short), filters.
Rank Setups (~1 day): List top 3 setups by probability/ATR.
Backtesting (~3 days): Test setups on 30d KuCoin data.
Alerts (~1-2 days): Push high-prob setups to Telegram.
...
Last updated: 2025-09-23 12:30 BST
